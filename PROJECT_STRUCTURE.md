# FlockPoster CLI - Project Structure

## Overview

The FlockPoster CLI is a complete command-line interface package for interacting with the FlockPoster social media scheduling API. It's designed for developers and AI agents to automate social media posting.
...
│   ├── api.ts                    # API client for FlockPoster API
...
- Handles all HTTP requests to the FlockPoster API
- Methods for:
  - Creating posts
  - Listing posts
  - Deleting posts
...
- `uploadFile()` - Upload images to FlockPoster
...
- Version: `1.0.0`
- Executable bin: `flockposter` → `dist/index.js`
...
FLOCKPOSTER_API_KEY=test node dist/index.js integrations:list
```
...
2. **Features**
   - Interactive mode
   - Config file support (~/.flockposterrc)
...
- **Issues:** https://github.com/OfficeXApp/flockposter/issues
- **Docs:** See README.md, SKILL.md, QUICK_START.md
- **Website:** https://app.flockposter.com
