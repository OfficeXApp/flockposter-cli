...
# FlockPoster CLI - Command Line Examples
# Demonstrating the new -c and -m flag syntax

echo "🚀 FlockPoster CLI Command Line Examples"
echo ""
...
echo "Command:"
echo 'flockposter posts:create -c "Hello World!" -i "twitter-123"'
echo ""

# Example 2: Post with multiple images
echo "📸 Example 2: Post with multiple images"
echo "Command:"
echo 'flockposter posts:create \'
...
echo "Command:"
echo 'flockposter posts:create \'
echo '  -c "🧵 How to use FlockPoster CLI (1/5)" \'
