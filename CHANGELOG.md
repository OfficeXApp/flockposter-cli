...
All notable changes to the FlockPoster CLI will be documented in this file.
...
### Added
- Initial release of FlockPoster CLI
...
- Environment variable configuration (FLOCKPOSTER_API_KEY, FLOCKPOSTER_API_URL)
- Comprehensive help documentation
- Example scripts for basic usage and AI agent integration
- SKILL.md for AI agent usage patterns

### Features
- Command-line interface for FlockPoster API
