...
```bash
flockposter integrations:settings youtube-def456
```
...
```bash
flockposter integrations:settings twitter-ghi789
```
...
```bash
flockposter integrations:settings linkedin-jkl012
```
...
```bash
flockposter integrations:settings tiktok-mno345
```
...
```bash
flockposter integrations:settings instagram-pqr678
```
...
```bash
flockposter integrations:settings threads-stu901
```
...
flockposter integrations:settings reddit-456
```
...
```bash
flockposter integrations:settings twitter-789 | jq '.output.maxLength'
# Output: 280
```
...
flockposter integrations:settings reddit-123 | jq '.output.settings'

# Extract specific field properties
flockposter integrations:settings reddit-123 \
...
SETTINGS=$(flockposter integrations:settings reddit-123)
...
```bash
flockposter integrations:settings invalid-id
